...
import { Monitor, Braces, Settings, ArrowUpDown, Plug, History, ChevronsLeft, ChevronsRight, FolderOpen, Cloud } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: "r2",               icon: Cloud,          label: "R2",        page: "r2" },
